                        ...
                        @else
                            @foreach ($user as $item)
                                <tr>
                                    ...
                                    <td><a href="{{route('users.edit',$item->id)}}" class="btn btn-info btnsm"><i class="fas fa-edit"></i> Editar</a>
                                        <a href="{{route('users.confirmar',$item->id)}}" class="btn btn-danger btnsm"><i class="fas fa-trash"></i>
                                            Eliminar</a>
                                    </td>
