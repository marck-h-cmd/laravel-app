                        ...
                        @else
                            @foreach ($unidad as $itemunidad)
                                <tr>
                                    ...
                                    <td>{{ $itemunidad->estado }}</td>
                                    <td><a href="{{route('unidades.edit',$itemunidad->idunidad)}}" class="btn btn-info btnsm"><i class="fas fa-edit"></i> Editar</a>
                                        <a href="{{route('unidades.confirmar',$itemunidad->idunidad)}}" class="btn btn-danger btnsm"><i class="fas fa-trash"></i>
                                            Eliminar</a>
                                    </td>
